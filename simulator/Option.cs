...
public class ParamInputAggregate{
    public int SimulationPath {get;set;}
    public double SimulationDrift {get;set;}
...
{
    public double EuropeanOptionCalc(Int64 N, double T, double mu, double sigma, double s0, double k,
    ...
    public double AsianOptionCalc(Int64 N, double T, double mu, double sigma, double s0, double k,
        double r, double[,] price, bool iscall)
    {
        double[,] AveragePrice = new double[N, 1];
        var sum = 0.0;
    ...
    //     public double DigitalOptionCalc(Int64 N, double T, double mu, double sigma, double s0, double k,
