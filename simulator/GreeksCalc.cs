...
public class GreeksCalc
{
            ...
            double r, double[,] price, bool iscall, double[,]random_number)
        {
            ...
            var price_plus_deltas= StockSimulator.StockPath(N, T, mu, sigma, s0+delta_s, random_number);
            var price_minus_deltas = StockSimulator.StockPath(N, T, mu, sigma, s0-delta_s, random_number);
            ...
            var price_plus_delta_sigma= StockSimulator.StockPath(N, T, mu, sigma+delta_sigma, s0, random_number);
            var price_minus_delta_simga = StockSimulator.StockPath(N, T, mu, sigma-delta_sigma, s0, random_number);
            ...
            var price_plus_delta_T= StockSimulator.StockPath(N, T+delta_T, mu, sigma, s0, random_number);
            var price_minus_delta_T = StockSimulator.StockPath(N, T-delta_T, mu, sigma, s0, random_number);
